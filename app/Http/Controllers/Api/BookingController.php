...
class BookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $startHour = Carbon::createFromFormat('H:i', $request->start_time)->hour;
        $endHour = Carbon::createFromFormat('H:i', $request->end_time)->hour;
        ...
        $totalPrice = $duration * $guide->hourly_rate;
