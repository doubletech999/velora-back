...
function viewBooking(bookingId) {
    ...
    const customerName = row.querySelector('[data-customer-name]').getAttribute('data-customer-name');
    const customerEmail = row.querySelector('[data-customer-email]').getAttribute('data-customer-email');
    const guideName = row.querySelector('[data-guide-name]').getAttribute('data-guide-name');
    const guideRate = row.querySelector('[data-guide-rate]').getAttribute('data-guide-rate');
    ...
    const duration = row.querySelector('[data-duration]').getAttribute('data-duration');
    ...
    content.innerHTML = `
        ...
        <div class="border-b pb-3">
            ...
            <p class="text-sm font-medium">${duration} hour(s)</p>
        </div>
        <div class="border-b pb-3">
